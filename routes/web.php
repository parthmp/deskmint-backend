...
Route::get('/', function () {
	...
	$snapshot = app(InvoiceSnapshot::class)->setCompanyId(1)->setInvoiceId(82)->setTimezoneOffset(-330)->setLogoSnapsot()->setGeneralSettings()->setClientSnapshot()->setCompanySnapshot()->setInvoiceSnapshot();
