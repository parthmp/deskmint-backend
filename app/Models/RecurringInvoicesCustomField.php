...
class RecurringInvoicesCustomField extends Model
{
    use SoftDeletes, HasFactory;

	protected $table = 'recurring_invoices_custom_fields';
	...
	public function customFieldValue(){
		return $this->hasOne(RecurringInvoiceCustomFieldValue::class);
	}
