...
class InvoiceSettingsClientDetailsController extends Controller{
	...
	private function getClientDetailFields() : ClientsDetailsFields {
		return new ClientsDetailsFields('invoice_client_details', 'id', 'clients_custom_fields_id');
	}
	...
	public function show(Request $request) : mixed{
		...
		return (new SettingsArrangedFields($this->getClientDetailFields(), $request, $company_id))->fetchArrangedFieldsData();
