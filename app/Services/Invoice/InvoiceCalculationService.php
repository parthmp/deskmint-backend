...
class InvoiceCalculationService{
	...
	public function calculateInvoice(array $product_rows, string $discount_type, string $discount_number) : array {
		...
		$global_subtotal = $this->global_subtotal->toScale(2, RoundingMode::HALF_UP)->__toString();
		$global_tax_amount = $this->global_tax_amount->toScale(2, RoundingMode::HALF_UP)->__toString();
		$global_total = $global_total->toScale(2, RoundingMode::HALF_UP)->__toString();
		$global_discount_amount = $this->global_discount_amount->toScale(2, RoundingMode::HALF_UP)->__toString();
